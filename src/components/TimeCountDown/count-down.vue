<template>
  <div class="count-down">
    ...
    <div v-if="countDownStatus != countDownStatusObj.OVER" class="times flex-center">
      ...
      <template v-if="theCountDown.day<1">
        <div class="count-time count-hours flex-center" :style="timeStyle">
          {{ (theCountDown.hours) | formatTime }}
        </div>
        <div
          class="timeName"
          :style="timeNameStyle"
...
import { COUNT_DOWN_STATUS } from './count-down.js'
...
export default {
  ...
  props: {
    ...
    /** 进行中状态 文字 */
    processingText: { type: String, require: false, default: '剩' },
    /** 结束后状态 文字 */
